...
```{figure} ../imgs/ad_forward_alg.png
---
width: 600px
align: center
name: ad_forward_alg
...
```{figure} ../imgs/ad_reverse_alg.png
---
width: 600px
align: center
name: ad_reverse_alg
...
```{figure} ../imgs/ad_reverse_mlp.png
---
width: 600px
align: center
name: ad_reverse_mlp
...
```{figure} ../imgs/ad_ff_example2.png
---
width: 600px
align: center
name: ad_ff_example2
