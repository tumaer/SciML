...
```{figure} ../imgs/log_reg_confidence.png
---
width: 500px
align: center
...
```{figure} ../imgs/good_vs_bad_classifier_svm.png
---
width: 400px
align: center
...
```{figure} ../imgs/geometric_margin.png
---
width: 300px
align: center
...
```{figure} ../imgs/maximum_margin_classifier.png
---
width: 400px
align: center
...
```{figure} ../imgs/maximum_margin_classifier_solution.png
---
width: 500px
align: center
...
As $\omega^{\star^\top} \omega^{\star} = 1$, we can then solve for $b^{\star}$ and obtain the result in Eq. {eq}`mmc_bstar`.
...
```{figure} ../imgs/svm_nonlinearly_separable.png
---
width: 500px
align: center
...
```{figure} ../imgs/svm_sets_with_outlier.png
---
width: 500px
align: center
...
```{figure} ../imgs/soft_margin_classifier.png
---
width: 500px
align: center
...
```{figure} ../imgs/sequential_minimal_optimization.png
---
width: 500px
align: center
...
```{figure} ../imgs/sequential_minimal_optimization_truncation.png
---
width: 500px
align: center
...
```{figure} ../imgs/kernel_feature_map.png
---
width: 600px
align: center
...
```{figure} ../imgs/xnor_example_embedded.png
---
width: 600px
align: center
